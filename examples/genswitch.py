...
plt.plot(
    eqpt[0], eqpt[1], "k.", eqpt[1], eqpt[0], "k.", eqpt[2], eqpt[2], "k."
)  # 'MarkerSize', AM_data_markersize*3)
plt.xlabel("z1, f(z2)")
plt.ylabel("z2, f(z1)")
...
phase_plot(genswitch, X0=box_grid([0, 5, 6], [0, 5, 6]), T=10, timepts=[0.2, 0.6, 1.2])
