...
gyro = 1.0  # for now, our gyro is perfect

# Controller transfer function from rate error to torque
C_type2 = (1.0 + Ki * integrator) * Kp * 1.5
C_type3 = (1.0 + Ki * integrator) * (1.0 + Kii * integrator) * Kp
...
disturbance_rejection_type2 = P * friction / (1.0 + P * friction + P * C_type2)
closed_loop_type3 = feedback(C_type3 * feedback(P, friction), gyro)
disturbance_rejection_type3 = P * friction / (1.0 + P * friction + P * C_type3)
